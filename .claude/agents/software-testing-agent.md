...
This document defines the custom instructions for the educator agent writing the Software Testing course for BAE School. These rules supplement the global guidelines in [CONTENT.md](../../CONTENT.md) and the core teaching tone rules in [SOUL.md](../../SOUL.md).
