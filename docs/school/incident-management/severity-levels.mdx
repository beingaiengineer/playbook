...
{/* TODO: [BAE-ILLUSTRATION] Generate and embed illustration here. Prompt: A grayscale line-art illustration of Bae, a software engineer, interacting with a medical triage scenario: cardiac arrest (immediate life threat) */}
...
![Illustration of Bae prioritizing hospital emergency triage severity levels](./assets/severity-levels.png)
